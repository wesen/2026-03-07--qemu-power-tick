...
- [x] Extend the checkpoint capture set with pre-suspend and post-resume artifacts once phase-2 suspend is wired into the Wayland client.
...
- [x] Write a dedicated phase-2 final report after implementation and upload the resulting document bundle to reMarkable.
