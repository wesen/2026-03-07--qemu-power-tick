...
cp "$SCRIPT_DIR/dump_wayland_screenshot.sh" "$ROOTFS/usr/bin/dump_wayland_screenshot.sh"
cp "$SCRIPT_DIR/dump_fb0_snapshot.sh" "$ROOTFS/usr/bin/dump_fb0_snapshot.sh"
...
chmod +x "$ROOTFS/init" "$ROOTFS/usr/bin/display_probe.sh" "$ROOTFS/usr/bin/dump_wayland_screenshot.sh" "$ROOTFS/usr/bin/dump_fb0_snapshot.sh" "$ROOTFS/usr/bin/chromium-wayland-launcher" "$ROOTFS/usr/bin/suspendctl"
