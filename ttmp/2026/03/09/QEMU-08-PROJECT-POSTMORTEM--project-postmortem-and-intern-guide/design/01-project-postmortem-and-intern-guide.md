...
RelatedFiles:
    - Path: PROJECT-POSTMORTEM-AND-INTERN-GUIDE.md
      Note: Root-level version of the final report
    - Path: README.md
      Note: Entry point linking to the root-level report
    - Path: guest/build-phase2-rootfs.sh
      Note: Representative Weston-path packaging script discussed in the report
    - Path: guest/init-phase4-drm
      Note: Representative direct-DRM bootstrap script discussed in the report
ExternalSources: []
Summary: Project-level retrospective, architecture guide, implementation map, and postmortem for the QEMU sleep/wake lab repository.
LastUpdated: 2026-03-09T23:16:00-04:00
WhatFor: Give a new contributor one detailed document that explains what was built, how the repository is organized, what succeeded, what failed, and what to do next.
WhenToUse: Read this first when onboarding to the repository or preparing a project-level review.
---
...
- [QEMU-01](../../../../03/07/QEMU-01-LAB-ONE--qemu-lab-one-analysis-and-implementation-guide/index.md)
- [QEMU-02](../../../../03/07/QEMU-02-LAB-TWO--qemu-lab-two-wayland-client-analysis-and-implementation/index.md)
- [QEMU-04](../../../../03/07/QEMU-04-LAB-THREE--qemu-lab-three-chromium-kiosk-analysis-and-implementation/index.md)
- [QEMU-05](../../../../03/07/QEMU-05-DEVICES-RESUME-INVESTIGATION--devices-resume-display-ownership-investigation/index.md)
- [QEMU-06](../../../../03/08/QEMU-06-CONTENT-SHELL-DRM-OZONE--chromium-content-shell-direct-drm-ozone-analysis-and-implementation/index.md)
- [QEMU-07](../../../../03/09/QEMU-07-CONTENT-SHELL-MODESET--content-shell-drm-modeset-and-controller-mapping-investigation/index.md)
...
- [QEMU-02 final report](../../../../03/07/QEMU-02-LAB-TWO--qemu-lab-two-wayland-client-analysis-and-implementation/design-doc/03-phase-2-final-implementation-report.md)
...
- [QEMU-04 index](../../../../03/07/QEMU-04-LAB-THREE--qemu-lab-three-chromium-kiosk-analysis-and-implementation/index.md)
...
- [QEMU-06 direct DRM/Ozone guide](../../../../03/08/QEMU-06-CONTENT-SHELL-DRM-OZONE--chromium-content-shell-direct-drm-ozone-analysis-and-implementation/design-doc/01-direct-drm-ozone-content-shell-analysis-and-implementation-guide.md)
- [QEMU-07 modeset/controller investigation](../../../../03/09/QEMU-07-CONTENT-SHELL-MODESET--content-shell-drm-modeset-and-controller-mapping-investigation/design/01-content-shell-modeset-mapping-investigation-guide.md)
...
3. Read [QEMU-02 final report](../../../../03/07/QEMU-02-LAB-TWO--qemu-lab-two-wayland-client-analysis-and-implementation/design-doc/03-phase-2-final-implementation-report.md).
4. Read [QEMU-05 analysis guide](../../../../03/07/QEMU-05-DEVICES-RESUME-INVESTIGATION--devices-resume-display-ownership-investigation/design-doc/01-devices-resume-analysis-guide.md).
5. Read [QEMU-07 guide](../../../../03/09/QEMU-07-CONTENT-SHELL-MODESET--content-shell-drm-modeset-and-controller-mapping-investigation/design/01-content-shell-modeset-mapping-investigation-guide.md).
