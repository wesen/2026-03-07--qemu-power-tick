...
KERNEL=
INITRAMFS=
RESULTS_DIR=${RESULTS_DIR:-results-phase4}
SERIAL_LOG=${SERIAL_LOG:-$RESULTS_DIR/guest-serial.log}
QMP_SOCKET=${QMP_SOCKET:-$RESULTS_DIR/qmp.sock}
MEMORY_MB=${MEMORY_MB:-4096}
APPEND_EXTRA=${APPEND_EXTRA:-"phase4_runtime_seconds=20 phase4_mode=kms-pattern"}
DISPLAY_DEVICE=${DISPLAY_DEVICE:-virtio-gpu-pci,id=labgpu}
