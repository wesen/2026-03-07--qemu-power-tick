...
APPEND="console=ttyS0 panic=-1 rdinit=/init sleepdemo.host=10.0.2.2 sleepdemo.port=$HOST_PORT sleepdemo.idle=$IDLE_SECONDS sleepdemo.pm_test=$PM_TEST sleepdemo.max_suspend_cycles=$MAX_SUSPEND_CYCLES"
